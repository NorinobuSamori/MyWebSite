...
<body class="color-lightgreen">
	...
	<div class="container">
		<br> <br>
		<h1 class="text-center">イベント削除</h1>
		<h1 class="text-center">本当に削除しますか？</h1>
		<br> <br>
		<div class="row">
		<form action="Index">
			<div class="col  width50"> <%-- actionはformタグに設定する可能性あり --%>
				<button class="btn col btncolor1" type="submit"
					>取りやめる</button>
				</div>
		</form>
			 <span class="col  width50"></span>
			<form action="MasterEventDelete?id=${BeansEventDetailInfo.id}"
				method="post">
				<div class="col  width50">
					<button class="btn  col btncolor1" type="submit">削除する</button>
				</div>
			</form>

		</div>
		<br> <br>
		<h1 class="text-center">概要表</h1>
				...
				<div class="class-table width2 border-radius ">
					...
					<div class="class-table-row">
						...
						<div class="class-table-cell class-table-cell-right1">有名Webサービス運営企業で導入されたカリキュラムと
							...
							最高のカリキュラムを使って480時間現役エンジニアとマンツーマンで学ぶ短期集中プログラム。株式会社DMM.comラボ、株式会社ぐるなび、株式会社NTTコム
							オンライン・マーケティング・ソリューション株式会社といった有名企業も含め、毎年400名以上の新人エンジニアを育成してきたノウハウを詰め込んだ実践カリキュラムをオンラインテキスト化。
					...
					<div class="class-table-row">
						...
						<div class="class-table-cell class-table-cell-right1">日本
							関東地域</div>
					</div>
					<div class="class-table-row">
						<div class="class-table-cell class-table-cell-left1">参加費用</div>
						<div class="class-table-cell class-table-cell-right1">0円</div>
					</div>
					<div class="class-table-row">
						<div class="class-table-cell class-table-cell-left1">交通</div>
						<div class="class-table-cell class-table-cell-right1">
							〒103-0015 東京都中央区日本橋箱崎町27-2 渡菊第3ビル 6階 東京メトロ半蔵門線「水天宮前駅」より徒歩３分
							東京メトロ日比谷線・東西線「茅場町駅」より徒歩10分</div>
					</div>
					<div class="class-table-row">
						<div class="class-table-cell class-table-cell-left1">参加資格</div>
						<div class="class-table-cell class-table-cell-right1">
							選考などは実施しておりません。以下の5つの条件を満たしている方であればどなたでもご参加いただくことができます。<br>
							<br> 1．東京、神奈川、千葉、埼玉にお住まいの方 <br> 2．ご年齢が18歳以上、30歳未満の方 <br>
							3．週3日以上、スクールに通学して学習・就職活動可能な方 <br> 4．日本国籍をお持ちの方 <br>
							5．以下のいずれかに当てはまる方 <br> ・アルバイト・フリーターの方 <br>
							・現在離職中、または3ヶ月以内に現職を退職予定の会社員の方 <br>
							・大学/専門学校に在籍している、2019年度就活生の方 <br> ・現在無職で、正社員の仕事をお探しの方 <br>
						</div>
					</div>
					<div class="class-table-row">
